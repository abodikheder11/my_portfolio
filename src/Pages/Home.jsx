...
const WORDS = ["Network & Telecom Graduate", "Tech Enthusiast"];
const TECH_STACK = ["Flutter","Dart", "React Native","Javascript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/abodikheder11" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/abdullah-kheder-8497822a6/" },
  { icon: Instagram, link: "https://www.instagram.com/abodiikheder/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Experienced in developing scalable, responsive mobile apps with Flutter and React Native.
                </p>
