...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/abdullah-kheder-8497822a6/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@AbdullahKheder",
    icon: Instagram,
    url: "https://www.instagram.com/abodiikheder/?hl=id",
    color: "#E4405F",
...

  {
    ...
    subText: "@Abdullah",
    icon: Github,
    url: "https://github.com/abodikheder11",
    color: "#ffffff",
